...
//             <div
//                 className={`bg-${
//                     isScrolled ? "white" : "#2727d0"
//                 } fixed-top hidden md:flex justify-between items-center text-${
//                     isScrolled ? "black" : "white"
//                 } md:px-20 lg:px-32 py-2 text-[16px]`}
//             >
//                 <div>
...
//                         }`}
//                     />
//                     <h1 className="text-[20px] font-semibold">Animaker</h1>
//                 </div>
    ...
    return (
        <div>
            ...
            <div
                className={`bg-${
                    isScrolled ? "white" : "#2727d0"
                } fixed-top md:hidden flex justify-between items-center text-${
                    isScrolled ? "black" : "white"
                } py-8 text-[16px]`}
            >
                <div className="flex justify-between items-center py-2 px-3 fixed-top z-10">
                    {/* This div is for logo */}
                    <div className="flex items-center gap-x-2">
                        <img
                            src={logo}
                    ...
                    {toggle ? (
                        <MdOutlineClose
                            onClick={() => setToggle(!toggle)}
                            className={`shadow-sm mr-2 hover:cursor-pointer transition-transform transform scale-95 duration-1000 ${isScrolled ? 'text-black': 'text-white'}`}
                        ...
                        <AiOutlineMenu
                            onClick={() => setToggle(!toggle)}
                            className={`mr-2 shadow-sm hover:cursor-pointer transition-transform duration-1000 scale-95 ${isScrolled ? "text-black" : "text-white"}`}
                            size={30}
                        />
                    )}
                </div>
                ...
                <ul
                    className={`fixed h-1/2 w-[300px] bg-white z-10 top-[62px] transition-all ease-in-out duration-700
        ${toggle ? "left-0" : "left-[-100%]"} px-8 py-8`}
                >
                    <div className="flex flex-col">
                        <Link to="/animate">
