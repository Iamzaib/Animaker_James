...
export default function EditingTools() {
    ...
    return (
        ...
        <div className='p-3 rounded-3xl'>
            ...
            <div className='md:w-[70%] md:relative md:text-white top-44 md:-mt-28 p-3 bg-white lg:bg-transparent rounded-t-2xl' data-aos="zoom-in-up" data-aos-duration="1000">
