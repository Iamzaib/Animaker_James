    ...
    return (
        ...
        <div className="mt-20 px-1">
            <div className="w-full md:w-[65%]lg:w-[55%] mx-auto">
                <h1
                    className=" flex justify-center lg:justify-start text-[33px] text-center md:text-left md:text-[55px] font-bold"
                    data-aos="zoom-in-up"
                ...
                <h1
                    className="font-bold text-[33px] text-center md:text-left md:text-[50px]"
                    data-aos="zoom-in-up"
                    data-aos-duration="2000"
                >
                    {" "}
                    <span className='className=" flex justify-center lg:justify-start text-[33px] md:text-[55px] bg-gradient-to-r from-[#3939D4] to-[#8F3CEB] font-bold text-transparent bg-clip-text'>
                        for top notch Creaters
                    </span>{" "}
                </h1>
                <p
                    className="font-bold text-[20px] text-gray-400 flex justify-center lg:justify-start pt-3"
                    data-aos="zoom-in-up"
                    data-aos-duration="2000"
                >
            ...
            <div>
                ...
                <div
                    className="w-[100%]  md:flex justify-between items-center"
                    data-aos="zoom-in-up"
                    data-aos-duration="2000"
                >
                    ...
                    <div
                        className="lg:w-[40%] relative -mt-24 hover:scale-105 duration-200 hover:cursor-pointer sm:mt-4 md:mt-1 lg:mt-24 "
                        data-aos="zoom-in-up"
                        data-aos-duration="2000"
                    >
                        <p className="relative px-4 top-36 w-[80%] mx-auto text-white font-semibold text-[19px]">
