            ...
            <div className="inline-flex h-fit justify-center w-full  ">
                <ul className="flex justify-evenly border-2 border-b-[#797979] border-transparent cursor-pointer  overflow-auto">
                    {labels.map((label, index) => (
                        <h1
                            key={index}
                            className={`list-none font-bold text-[16px] md:text-[20px] text-[#0a0f4098] p-4 cursor-pointer ${activeIndex === index
                ...
                <div className="flex flex-col h-full items-center justify-center w-full md:mt-12 gap-4 ">
                    <div className="flex  justify-center  ">
                        {headings.map((heading, index) => (
                            ...
                            >
                                {activeIndex === index ?
                                    <><h2 className="font-bold text-[25px]  text-[#0a0f40] p-4" data-aos="fade-up" data-aos-duration="1000">{heading}</h2></>
                                    :
                                    ''
                                }
                            </div>
                    ...
                    <ul className="flex justify-center ">
                        {descriptions.map((description, index) => (
                            ...
                            >
                                {activeIndex === index ?
                                    <><p className="font-normal px-1 text-[18px] mx-auto text-[#0a0f40d8] md:w-96 " data-aos="fade-up" data-aos-duration="1000">{description}</p></>
                                    :
                                    ''
                                }
                            </li>
